...
---------------------- INPUT FILES ---------------------------------------------
"NRELOffshrBsline5MW_OC3Monopile_ElastoDyn_Work.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"../data/5MW_Baseline/NRELOffshrBsline5MW_BeamDyn.dat"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"../data/5MW_Baseline/NRELOffshrBsline5MW_BeamDyn.dat"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"../data/5MW_Baseline/NRELOffshrBsline5MW_BeamDyn.dat"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"NRELOffshrBsline5MW_InflowWind_Work.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../data/5MW_Baseline/NRELOffshrBsline5MW_OC3Monopile_AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"../data/5MW_Baseline/NRELOffshrBsline5MW_OC3Monopile_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"../data/5MW_Baseline/NRELOffshrBsline5MW_OC3Monopile_HydroDyn.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"../data/5MW_Baseline/NRELOffshrBsline5MW_OC3Monopile_SubDyn.dat"    SubFile         - Name of file containing sub-structural input parameters (quoted string)
