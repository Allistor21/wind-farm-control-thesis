...
for j = 1:length(objs)
    [optimiserOut,deltaP,deltaL] = FASTnATOptimiser_old(N,Uinf,TIinf,X,wakeModelType,coeffsFitObjStruct,coeffsFitObjArrayCt,x0,objs(j),options)
    ...
    name = ['Algorithm_3___obj_' num2str(objs(j)) '.png'];
    saveas(gcf,name)
end
